...
const line = (inner: TemplateResult): TemplateResult => html`
...
export const sheetIcons = {
  collapse: line(html`<path d="M6 9l6 6 6-6" />`),
  expand: line(html`<path d="M6 15l6-6 6 6" />`),
  close: line(html`<path d="M6 6l12 12M18 6L6 18" />`),
  bus: line(html`
